...
### [Google System Design Problems](google-systems/)
...
- **[Design Google Search](google-systems/google-search)**: 100B+ pages, <100ms latency, PageRank
- **[Design YouTube](google-systems/google-youtube)**: 500hrs/min uploads, adaptive streaming, recommendations 
- **[Design Google Maps](google-systems/google-maps)**: Real-time traffic, routing algorithms, offline maps
- **[Design Gmail](google-systems/google-gmail)**: 300B emails/day, spam filtering, search
- **[Design Google Docs](google-systems/google-docs)**: Real-time collaboration, conflict resolution, OT
...
- [:material-map-marker:{ .lg .middle } **Uber Location System**](uber-location)
...
- [:material-database-outline:{ .lg .middle } **Amazon DynamoDB**](amazon-dynamo)
...
- [:material-music:{ .lg .middle } **Spotify Recommendations**](spotify-recommendations)
...
### [PayPal: Distributed Payment Processing](paypal-payments)
...
1. Start with [Uber's Location System](uber-location) - Classic distributed systems challenges
2. Study [DynamoDB](amazon-dynamo) - Database internals
3. Explore [PayPal](paypal-payments) - Transaction processing

### For ML Engineers
1. Begin with [Spotify Recommendations](spotify-recommendations) - ML at scale
2. Review [Uber's Location](uber-location) - Real-time features
3. Examine feature stores and pipelines

### For Gaming Engineers
1. Focus on **Fortnite** - State synchronization (coming soon)
2. Study [Uber](uber-location) - Real-time systems
3. Learn about edge computing patterns

### For Reliability Engineers
1. Start with **SpaceX** - Safety-critical systems (coming soon)
2. Study [DynamoDB](amazon-dynamo) - High availability
...
**Latency & Performance**
- [Uber Location](uber-location) - Sub-100ms global updates
- Coming Soon: Fortnite - Real-time game state

**Availability & Resilience**
- [Amazon DynamoDB](amazon-dynamo) - 99.999% availability
- Coming Soon: SpaceX - Safety-critical systems

**Scale & Intelligence**
- [Spotify Recommendations](spotify-recommendations) - 5B recommendations/day
- [PayPal Payments](paypal-payments) - $1.36T/year processing
...
**Amazon & AWS:**
- **[Amazon DynamoDB](amazon-dynamo)** - Eventually consistent key-value store achieving 99.999% availability
- **[Amazon Aurora](amazon-aurora)** - Cloud-native relational database with multi-master replication
- **[S3 Object Storage (Enhanced)](s3-object-storage-enhanced)** - Scalable object storage design patterns

**Google:**
- **[Google Drive](google-drive)** - Distributed file storage and synchronization
- **[Google Maps](google-maps)** - Real-time mapping at planetary scale
- **[Google Spanner](google-spanner)** - Globally distributed, strongly consistent database
- **[YouTube](youtube)** - Video streaming infrastructure serving billions

**Netflix:**
- **[Netflix Streaming](netflix-streaming)** - Adaptive streaming and CDN architecture
- **[Netflix Chaos Engineering](netflix-chaos)** - Resilience through controlled failure

**Other Tech Giants:**
- **[Apple Maps](apple-maps)** - Privacy-focused mapping infrastructure
- **[PayPal Payments](paypal-payments)** - Distributed payment processing at $1.36T/year scale
- **[Spotify Recommendations](spotify-recommendations)** - ML-powered personalization serving 5B recommendations/day
- **[Twitter Timeline](twitter-timeline)** - Real-time timeline generation at scale
- **[Uber Location Services](uber-location)** - Real-time location tracking for 40M concurrent users

#### Communication & Messaging Systems

- **[Chat System](chat-system)** - Real-time messaging architecture with 2,320 lines of comprehensive design
- **[Consistency Deep Dive Chat](consistency-deep-dive-chat)** - Advanced consistency patterns in chat applications
- **[Distributed Email (Enhanced)](distributed-email-enhanced)** - Modern email architecture patterns
- **[Distributed Message Queue](distributed-message-queue)** - Scalable message queuing design
- **[News Feed](news-feed)** - Social media feed generation
- **[Notification System](notification-system)** - Multi-channel notification delivery
- **[Social Media Feed](social-media-feed)** - Feed ranking and distribution

#### 🗄 Storage & Database Systems

**Core Distributed Systems:**
- **[Apache Kafka](kafka)** - Distributed streaming platform
- **[Apache Spark](apache-spark)** - Unified analytics engine
- **[Cassandra](cassandra)** - Wide column store database
- **[Consistent Hashing](consistent-hashing)** - Fundamental distributed systems technique
- **[ElasticSearch](elasticsearch)** - Distributed search and analytics
- **[etcd](etcd)** - Distributed key-value store
- **[Key-Value Store](key-value-store)** - Building blocks of distributed storage
- **[MapReduce](mapreduce)** - Large-scale data processing
- **[Memcached](memcached)** - High-performance caching
- **[MongoDB](mongodb)** - Document-oriented database
- **[Object Storage](object-storage)** - Scalable unstructured data storage
- **[Redis](redis)** - In-memory data structure store
- **[Redis Architecture](redis-architecture)** - Deep dive into Redis internals
- **[ZooKeeper](zookeeper)** - Distributed coordination service

#### Financial & E-commerce Systems

- **[Digital Wallet (Enhanced)](digital-wallet-enhanced)** - Modern digital wallet architecture
- **[Ecommerce Platform](ecommerce-platform)** - Complete e-commerce system design
- **[Hotel Reservation](hotel-reservation)** - Booking system with inventory management
- **[Payment System](payment-system)** - Core payment processing patterns
- **[Stock Exchange](stock-exchange)** - High-frequency trading architecture

#### 📍 Location & Mapping Services

- **[Find My Device](find-my-device)** - Device tracking infrastructure
- **[HERE Maps](here-maps)** - Global mapping platform
- **[Life360](life360)** - Family location sharing
- **[Nearby Friends](nearby-friends)** - Proximity-based social features
- **[OpenStreetMap](openstreetmap)** - Crowdsourced mapping
- **[Proximity Service](proximity-service)** - Location-based discovery
- **[Snap Map](snap-map)** - Real-time location sharing
- **[Strava Heatmaps](strava-heatmaps)** - Activity aggregation and visualization
- **[Uber Maps](uber-maps)** - Real-time navigation for ride-sharing

#### Search & Discovery

- **[Search Autocomplete](search-autocomplete)** - Real-time search suggestions
- **[Social Graph](social-graph)** - Graph database for social connections
- **[Web Crawler](web-crawler)** - Distributed web crawling architecture

#### Monitoring & Infrastructure

- **[Ad Click Aggregation](ad-click-aggregation)** - Real-time analytics pipeline
- **[Gaming Leaderboard (Enhanced)](gaming-leaderboard-enhanced)** - Global ranking systems
- **[HashiCorp Vault](vault)** - Secret management infrastructure
- **[Kubernetes](kubernetes)** - Container orchestration platform
- **[Metrics & Monitoring](metrics-monitoring)** - Observability infrastructure
- **[Prometheus](prometheus)** - Time-series monitoring
- **[Prometheus & Datadog (Enhanced)](prometheus-datadog-enhanced)** - Modern monitoring stack
- **[Rate Limiter](rate-limiter)** - API rate limiting at scale
- **[Unique ID Generator](unique-id-generator)** - Distributed ID generation
- **[URL Shortener](url-shortener)** - URL shortening service design
- **[Video Streaming](video-streaming)** - Adaptive video delivery
...
1. [Consistent Hashing](consistent-hashing) - Core concept
2. [Key-Value Store](key-value-store) - Basic building block
3. [DynamoDB](amazon-dynamo) - Production implementation
