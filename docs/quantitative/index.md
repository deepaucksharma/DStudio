...
- :material-ladder:{ .lg .middle } **[Latency Ladder 2025](latency-ladder.md)**
    
    ---
    
    Know your physics: every operation has a cost
    
    [Learn more →](latency-ladder.md)

- :material-ruler-square:{ .lg .middle } **[Little's Law Deep-Dive](littles-law.md)**
    
    ---
    
    The most important equation in systems thinking
    
    [Learn more →](littles-law.md)

- :material-chart-bar:{ .lg .middle } **[Queueing Theory](queueing-models.md)**
    
    ---
    
    When will your system hit the wall?
    
    [Learn more →](queueing-models.md)
...
- :material-arrow-split-vertical:{ .lg .middle } **[Amdahl & Gustafson Laws](amdahl-gustafson.md)**
    
    ---
    
    The limits of parallelization
    
    [Learn more →](amdahl-gustafson.md)

- :material-earth:{ .lg .middle } **[Universal Scalability Law](universal-scalability.md)**
    
    ---
    
    Why systems don't scale linearly
    
    [Learn more →](universal-scalability.md)
...
- :material-handshake:{ .lg .middle } **[Coordination Costs](coordination-costs.md)**
    
    ---
    
    The hidden tax of distributed systems
    
    [Learn more →](coordination-costs.md)

- :material-memory:{ .lg .middle } **[Cache Economics](cache-economics.md)**
    
    ---
    
    When caching saves money
    
    [Learn more →](cache-economics.md)

- :material-check-circle:{ .lg .middle } **[Availability Math](availability-math.md)**
    
    ---
    
    Building reliable systems from unreliable parts
    
    [Learn more →](availability-math.md)

- :material-chart-line:{ .lg .middle } **[Capacity Planning](capacity-planning.md)**
    
    ---
    
    Right-sizing for the future
    
    [Learn more →](capacity-planning.md)
...
- :material-pencil:{ .lg .middle } **[Numerical Problem Set](problem-set.md)**
    
    ---
    
    Practice problems with real-world parameters
    
    [Learn more →](problem-set.md)
...
- **[Computational Geometry](comp-geometry.md)** - Advanced spatial algorithms
