...
|---------|------------|------------|
| **[Law 1: Correlated Failure](/part1-axioms/law1-failure/)** | Components fail together | Failure domains |
| **[Failure Models](/quantitative/failure-models/)** | Types of failures | Failure patterns |
| **[SRE Practices](/human-factors/sre-practices/)** | Operational reliability | Error budgets |
| **[Chaos Engineering](/human-factors/chaos-engineering/)** | Testing reliability | Failure injection |
