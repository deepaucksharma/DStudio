...
- **Complementary**: [Zero-Trust Architecture](zero-trust-architecture/index.md) - Implementation of threat model findings
- **Complementary**: [Security Scanning Pipeline](security-scanning-pipeline/index.md) - Validation of threat controls
...
- [Microsoft Threat Modeling](https://docs.microsoft.com/en-us/azure/security/develop/threat-modeling-tool/index.md)
- [OWASP Threat Modeling](https://owasp.org/www-community/Threat_Modeling/index.md)
- [NIST Cybersecurity Framework](https://www.nist.gov/cyberframework/index.md)
- [STRIDE Threat Modeling](https://docs.microsoft.com/en-us/archive/msdn-magazine/2006/november/uncover-security-design-flaws-using-the-stride-approach/index.md)
