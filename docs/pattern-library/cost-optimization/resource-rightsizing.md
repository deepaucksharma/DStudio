...
- **Complementary**: [Spot Instance Management](spot-instance-management.md) - Cost optimization through pricing
- **Complementary**: [Reserved Capacity Planning](reserved-capacity-planning.md) - Long-term optimization
...
- [AWS Well-Architected Cost Optimization](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/welcome.html.md)
- [Google Cloud Rightsizing Recommendations](https://cloud.google.com/compute/docs/instances/apply-sizing-recommendations.md)
- [Azure Advisor Cost Recommendations](https://docs.microsoft.com/en-us/azure/advisor/advisor-cost-recommendations.md)
- [FinOps Foundation - Cloud Cost Optimization](https://www.finops.org/introduction/what-is-finops.md)
