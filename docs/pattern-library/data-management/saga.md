...
- [Circuit Breaker](../pattern-library/resilience/circuit-breaker.md) - Handling service failures
...
- **[Circuit Breaker](../pattern-library/resilience/circuit-breaker.md)**: Protect saga steps from failures
- **[Retry with Backoff](../pattern-library/resilience/retry-backoff.md)**: Handle transient failures
