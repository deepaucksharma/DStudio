...
|---------|-------------------|------------------|
| [Load Balancing](..../pattern-library/scaling.md/load-balancing.md) | Traffic distribution during scaling | Instance registration/deregistration |
| [Circuit Breaker](..../pattern-library/resilience.md/circuit-breaker.md) | Graceful degradation during scale-up | Prevent cascade failures |
| [Health Check](..../pattern-library/resilience.md/health-check.md) | Instance readiness validation | Safe traffic routing |
...
- :material-book-open-variant:{ .lg .middle } **Related Patterns**
    ...
    - [Load Balancing](..../pattern-library/scaling.md/load-balancing.md) - Traffic distribution foundation
    - [Health Check](..../pattern-library/resilience.md/health-check.md) - Instance readiness validation
    - [Circuit Breaker](..../pattern-library/resilience.md/circuit-breaker.md) - Failure protection during scaling

- :material-flask:{ .lg .middle } **Fundamental Laws**
    
    ---
    
    - [Law 2: Asynchronous Reality](../..../core-principles/laws.md/asynchronous-reality/index.md) - Distributed scaling coordination
    - [Law 7: Economic Reality](../..../core-principles/laws.md/economic-reality/index.md) - Cost optimization trade-offs

- :material-pillar:{ .lg .middle } **Foundational Pillars**
    
    ---
    
    - [Work Distribution](../..../core-principles/pillars.md/work-distribution/index.md) - Distributing load across instances
    - [Control Distribution](../..../core-principles/pillars.md/control-distribution/index.md) - Distributed scaling decisions
