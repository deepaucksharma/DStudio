...
- :material-flask:{ .lg .middle } **Fundamental Laws**
    ...
    - [Law 2: Asynchronous Reality](../../core-principles/laws/asynchronous-reality.md) - Distributed processing
    - [Law 4: Multidimensional Optimization](../../core-principles/laws/multidimensional-optimization.md) - Performance vs. cost trade-offs

- :material-pillar:{ .lg .middle } **Foundational Pillars**
    
    ---
    
    - [State Distribution](../../core-principles/pillars/state-distribution.md) - Distributed data storage
    - [Work Distribution](../../core-principles/pillars/work-distribution.md) - Parallel query processing
