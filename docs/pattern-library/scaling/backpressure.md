...
- :material-flask:{ .lg .middle } **Fundamental Laws**
    ...
    - [Law 2: Asynchronous Reality](../core-principles/laws/asynchronous-reality/index.md) - Distributed flow control

- :material-pillar:{ .lg .middle } **Foundational Pillars**
    
    ---
    
    - [Work Distribution](../core-principles/pillars/work-distribution/index.md) - Load balancing across consumers
    - [Control Distribution](../core-principles/pillars/control-distribution/index.md) - Distributed flow decisions
