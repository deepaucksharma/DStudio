...
- :material-flask:{ .lg .middle } **Fundamental Laws**
    ...
    - [Law 2: Asynchronous Reality](../core-principles/laws/asynchronous-reality/index.md) - Message passing nature
    - [Law 3: Emergent Chaos](../core-principles/laws/emergent-chaos/index.md) - Supervision hierarchies

- :material-pillar:{ .lg .middle } **Foundational Pillars**
    
    ---
    
    - [Work Distribution](../core-principles/pillars/work-distribution/index.md) - Actor-based work distribution
    - [Control Distribution](../core-principles/pillars/control-distribution/index.md) - Supervision patterns
