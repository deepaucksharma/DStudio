...
<!-- Navigation -->
[Home](../../introduction/index.md) → [Part I: Axioms](../index.md) → [Axiom 8](index.md) → **Economics Exercises**
...
**Previous**: [Examples](examples.md) | **Next**: [Part I Summary](../summary.md)

**Related**: [Capacity Planning](../../quantitative/capacity-planning.md) • [Auto-scaling](../../patterns/auto-scaling.md) • [Multi-region](../../patterns/multi-region.md)
