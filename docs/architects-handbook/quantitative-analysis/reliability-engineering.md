...
|---------|------------|------------|
| **[Law 1: Correlated Failure](../part1-axioms/law1-failure/index.md)** | Components fail together | Failure domains |
| **[Failure Models](failure-models.md)** | Types of failures | Failure patterns |
