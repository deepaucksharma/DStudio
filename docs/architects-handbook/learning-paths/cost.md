...
- **Pricing Models**
 ...
 - [Law 7: Economic Reality](../core-principles/laws/economic-reality/index.md) - Cost as a constraint
...
- [Serverless/FaaS](../pattern-library/architecture/serverless-faas/index.md) - Pay per use
- [Edge Computing](../pattern-library/scaling/edge-computing/index.md) - Reduce data transfer
...
- [Cell-Based Architecture](../pattern-library/architecture/cell-based/index.md) - Limit blast radius and cost
- [Lambda Architecture](../pattern-library/architecture/lambda-architecture/index.md) - Optimize batch vs stream
- [Data Mesh](../pattern-library/data-mesh.md/index.md) - Decentralized cost ownership
- [Bulkhead Pattern](../pattern-library/resilience/bulkhead/index.md) - Resource isolation
