...
- **Week 1: Infrastructure as Code** 
    ...
    **Day 1-2**: Terraform Basics
    - 📖 Read: [Infrastructure as Code Principles](../core-principles/infrastructure-as-code.md/)
...
- **Week 6: Advanced Observability**
    ...
    **Day 36-37**: SLI/SLO Implementation
    - 📖 Study: [SRE principles](../architects-handbook/implementation-playbooks/sre-practices/)
...
- **Week 7: Incident Management**
    ...
    **Day 43-44**: Incident Response Leadership
    - 📖 Study: [Incident command system](../architects-handbook/human-factors/incident-response/)
    - 🛠️ Practice: Incident response simulations
    - 📊 Success: Lead 3 mock incidents
    - ⏱️ Time: 6-8 hours
    
    **Day 45-46**: Blameless Postmortems
    - 📖 Read: [Postmortem culture](../architects-handbook/human-factors/blameless-postmortems/)
