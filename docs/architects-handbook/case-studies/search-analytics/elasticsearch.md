...
- [Key-Value Store](../../../architects-handbook/case-studies/databases/key-value-store.md) - Foundation for document storage
- [Cassandra](../../../architects-handbook/case-studies/databases/cassandra.md) - Alternative distributed database architecture
