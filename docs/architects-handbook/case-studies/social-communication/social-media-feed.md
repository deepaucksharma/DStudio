...
- [Notification System](/architects-handbook/case-studies/social-communication/notification-system/) - Real-time user engagement
- [Redis Architecture](/architects-handbook/case-studies/databases/redis-architecture/) - High-performance caching strategies
