...
- [Service Discovery](../pattern-library/service-discovery) - Core Kubernetes pattern
- [Health Checks](../pattern-library/health-check) - Liveness and readiness probes
- [Leader Election](../pattern-library/leader-election) - Used by control plane
- [Sidecar Pattern](../pattern-library/sidecar) - Common in Kubernetes
