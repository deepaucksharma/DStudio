...
- **[Caching Strategies](../pattern-library/caching-strategies)** - Multi-level caches
- **[Sharding](../pattern-library/sharding)** - Geographic partitioning
- **[Load Balancing](../pattern-library/load-balancing)** - Query distribution
