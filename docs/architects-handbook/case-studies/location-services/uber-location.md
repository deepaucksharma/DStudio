...
- :material-hexagon-multiple:{ .lg .middle } **[Geospatial Indexing](../../pattern-library/spatial-indexing.md/index.md)** 🥇
    ...
    **Open Source**: [H3 Library](https://h3geo.org/index.md)

- :material-broadcast:{ .lg .middle } **[Event Streaming](../../pattern-library/architecture.md/event-streaming/index.md)** 🥇
...
- :material-layers-triple:{ .lg .middle } **[Multi-Level Cache](../../pattern-library/scaling.md/caching-strategies/index.md)** 🥇
...
- :material-cloud-outline:{ .lg .middle } **[Edge Computing](../../pattern-library/scaling.md/edge-computing/index.md)** 🥇
...
- :material-sine-wave:{ .lg .middle } **[Adaptive Sampling](../../pattern-library/adaptive-sampling.md/index.md)** 🥈
...
- :material-crystal-ball:{ .lg .middle } **[Predictive Caching](../../pattern-library/predictive-caching.md/index.md)** 🥈
...
- :material-puzzle:{ .lg .middle } **[Data Partitioning](../../pattern-library/data-partitioning.md/index.md)** 🥈
...
[View Streaming Migration Guide →](../../excellence/migrations/polling-to-streaming/index.md)
</div>

## Related Topics

### Related Laws & Axioms
- [Law 1: Correlated Failure](../../core-principles/laws.md/correlated-failure/index.md) - Multi-region prevents city-wide outages
- [Law 2: Asynchronous Reality](../../core-principles/laws.md/asynchronous-reality/index.md) - Edge servers handle network latency
- [Law 3: Emergent Chaos](../../core-principles/laws.md/emergent-chaos/index.md) - Event-driven handles 1M updates/sec
- [Law 4: Multidimensional Optimization](../../core-principles/laws.md/multidimensional-optimization/index.md) - Battery vs accuracy trade-offs

### Related Patterns
- [Geospatial Indexing](../../pattern-library/spatial-indexing.md) - H3 hexagonal grid system
- [Event Streaming](../../pattern-library/architecture.md/event-streaming.md) - Kafka processing 100M events/day
- [Edge Computing](../../pattern-library/scaling.md/edge-computing.md) - 200+ edge locations globally
- [Time-Series Storage](../../pattern-library/time-series-ids.md) - Cassandra for location history

### Related Pillars
- [Pillar 1: Work](....../core-principles/pillars.md/work-distribution/index.md) - Geospatial sharding across regions
- [Pillar 2: State](....../core-principles/pillars.md/state-distribution/index.md) - Multi-layer location caching
- [Pillar 5: Intelligence](....../core-principles/pillars.md/intelligence-distribution/index.md) - ML-based ETA prediction
...
- **[Law 1: Correlated Failure](../../core-principles/laws.md/correlated-failure/index.md)** - Multi-region deployment prevents city-wide service outages during infrastructure failures
- **[Law 2: Asynchronous Reality](../../core-principles/laws.md/asynchronous-reality/index.md)** - Edge servers and predictive updates compensate for mobile network latency
- **[Law 3: Emergent Chaos](../../core-principles/laws.md/emergent-chaos/index.md)** - Event-driven architecture handles millions of concurrent location updates
- **[Law 4: Multidimensional Optimization](../../core-principles/laws.md/multidimensional-optimization/index.md)** - Balance battery life, accuracy, and real-time requirements through adaptive algorithms
- **[Law 5: Distributed Knowledge](../../core-principles/laws.md/distributed-knowledge/index.md)** - Comprehensive monitoring of location quality and system health across global infrastructure
- **[Law 6: Cognitive Load](../../core-principles/laws.md/cognitive-load/index.md)** - H3 indexing simplifies complex geospatial operations for developers
- **[Law 7: Economic Reality](../../core-principles/laws.md/economic-reality/index.md)** - Edge computing and compression optimize mobile data costs

### Related Pillars (Part II)
- **[Work Distribution](....../core-principles/pillars.md/work-distribution/index.md)** - Geospatial sharding distributes location processing across regions
- **[State Distribution](....../core-principles/pillars.md/state-distribution/index.md)** - Multi-layered caching strategy for location data at different time scales
- **[Intelligence Distribution](....../core-principles/pillars.md/intelligence-distribution/index.md)** - ML-based prediction algorithms deployed at edge locations
...
- **[Event Streaming](../../pattern-library/architecture.md/event-streaming/index.md)** - Kafka-based real-time location update pipeline
- **[Multi-Level Caching](../../pattern-library/scaling.md/caching-strategies/index.md)** - Hot/warm/cold storage architecture for location data

## Excellence Resources

### Implementation Guides
- [Real-Time Systems Guide](../../excellence/implementation-guides/real-time-systems/index.md) - Building sub-second latency systems
- [Geo-Distributed Systems](../../excellence/implementation-guides/geo-distributed-systems/index.md) - Managing global location data
- [Mobile Optimization Playbook](../../excellence/implementation-guides/mobile-optimization/index.md) - Battery and bandwidth optimization
...
### Pattern Comparisons
- [H3 vs S2 vs Geohash](../../excellence/comparisons/geospatial-indexing/index.md) - Choosing the right spatial index
- [Streaming vs Polling Trade-offs](../../excellence/comparisons/streaming-vs-polling/index.md) - When to migrate
- [Edge vs Central Processing](../../excellence/comparisons/edge-vs-central/index.md) - Location processing strategies

## Further Reading

- [H3: Uber's Hexagonal Hierarchical Spatial Index](https://eng.uber.com/h3/index.md)
- [Real-time Location Platform at Uber](https://eng.uber.com/realtime-location-platform/index.md)
- [Scaling Uber's Real-time Market Platform](https://eng.uber.com/real-time-market-platform/index.md)
- [Geospatial Indexing at Uber](https://eng.uber.com/geospatial-indexing-at-uber/index.md)
