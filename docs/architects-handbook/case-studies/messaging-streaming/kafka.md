...
- :material-publish:{ .lg .middle } **[Pub-Sub Messaging](../pattern-library/pub-sub.md)** 🥇
...
!!! info "Pattern Deep Dive: [Pub-Sub Messaging](../pattern-library/pub-sub.md)"
...
<div class="grid" markdown>
 ...
 <a href="../pattern-library/event-streaming" class="pattern-card">
