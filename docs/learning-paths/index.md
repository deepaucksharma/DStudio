...
<div class="path-selector">
  <div class="path-card beginner">
    ...
    <ul class="path-highlights">
      <li>✓ Physics-first approach</li>
      <li>✓ Hands-on exercises</li>
      <li>✓ Real failure stories</li>
      <li>✓ First distributed app</li>
    </ul>
...
2. **Foundation**: [The 8 Fundamental Axioms](../part1-axioms/index.md)
   - Day 1-2: [Latency - The Speed of Light Limit](../part1-axioms/axiom1-latency/index.md)
   - Day 3-4: [Capacity - Finite Resources](../part1-axioms/axiom2-capacity/index.md)
   - Day 5-6: [Failure - Things Break](../part1-axioms/axiom3-failure/index.md)
   - Day 7-8: [Concurrency - Race Conditions](../part1-axioms/axiom4-concurrency/index.md)
...
1. **Operations**: [Observability Basics](../patterns/observability.md)
2. **Human Factors**: [On-Call Best Practices](../human-factors/oncall-culture.md)
...
1. **Framework**: [The 5 Pillars Model](../part2-pillars/index.md)
2. **Analysis Tools**:
   - [Trade-off Matrices](../part2-pillars/tradeoff-calculus.md)
   - [Decision Trees](../part2-pillars/decision-tree.md)
...
1. **Cost Analysis**:
   - [Economics of Distribution](../part1-axioms/axiom8-economics/index.md)
   - [Multi-Cloud Strategy](../part1-axioms/axiom8-economics/examples.md#multi-cloud-arbitrage)
