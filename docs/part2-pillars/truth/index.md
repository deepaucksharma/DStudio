...
**This is distributed truth**: Multiple copies, no master, must agree somehow. This fundamental challenge emerges from [Law 1: Failure](../../part1-laws/axiom1-failure/index.md) (nodes can fail) and [Law 5: Epistemology](../../part1-laws/axiom5-epistemology/index.md) (agreement requires communication).
...
**Lesson**: Even "trustless" systems require human coordination when consensus breaks. This illustrates [Law 6: Human-API](../../part1-laws/axiom6-human-api/index.md) - humans remain the ultimate arbiters.
...
Raft achieves consensus by electing a leader that manages replication (addressing [Law 1: Failure](../../part1-laws/axiom1-failure/index.md)).
...
Vector clocks track causality in distributed systems without synchronized time (implementing [Law 2: Asynchronous Reality](../../part1-laws/axiom2-asynchrony/index.md) ordering guarantees).
...
CRDTs (Conflict-Free Replicated Data Types) guarantee eventual consistency without coordination. They elegantly sidestep [Law 5: Epistemology](../../part1-laws/axiom5-epistemology/index.md) costs by making all operations commutative.
...
1. **Expose uncertainty** - Don't pretend time is precise (acknowledging [Law 2: Asynchronous Reality](../../part1-laws/axiom2-asynchrony/index.md))
...
### 🌿 Intermediate
1. **CAP theorem forces truth trade-offs** (explored in depth in [Law 5: Epistemology](../../part1-laws/axiom5-epistemology/index.md))
...
### Foundational Laws
- [Law 1: Failure](../../part1-laws/axiom1-failure/index.md) - Why consensus protocols need fault tolerance
- [Law 2: Asynchronous Reality](../../part1-laws/axiom2-asynchrony/index.md) - Time uncertainty and event ordering
- [Law 3: Emergence](../../part1-laws/axiom3-emergence/index.md) - Unpredictable consensus behaviors
- [Law 5: Epistemology](../../part1-laws/axiom5-epistemology/index.md) - The cost of achieving consensus
- [Law 6: Human-API](../../part1-laws/axiom6-human-api/index.md) - Human intervention in consensus failures
