...
**Find it here:** [Law of Asynchronous Reality](..../core-principles/laws.md/asynchronous-reality/index.md)
...
- Gray failures (partial degradation/index)
- Metastable failure states
- Cascading failure analysis

**Find it here:** [Law of Correlated Failure](..../core-principles/laws.md/correlated-failure/index.md)
...
**Find it here:** [Law of Emergent Chaos](..../core-principles/laws.md/emergent-chaos/index.md)
...
**Find it here:** [Law of Multidimensional Optimization](..../core-principles/laws.md/multidimensional-optimization/index.md)
...
**Find it here:** [Law of Distributed Knowledge](..../core-principles/laws.md/distributed-knowledge/index.md)
...
**Find it here:** [Law of Cognitive Load](..../core-principles/laws.md/cognitive-load/index.md)
...
**Find it here:** [Law of Economic Reality](..../core-principles/laws.md/economic-reality/index.md)
...
4. Cognitive load (Law 6/index) informs API and tool design

## Quick Navigation

### If you're looking for content on...

- **Latency, RTT, speed of light** → [Law 2: Asynchronous Reality](..../core-principles/laws.md/asynchronous-reality/index.md)
- **Capacity planning, limits** → [Law 4: Trade-offs](..../core-principles/laws.md/multidimensional-optimization/index.md) and [Law 7: Economics](..../core-principles/laws.md/economic-reality/index.md)
- **Failure modes, fault tolerance** → [Law 1: Failure](..../core-principles/laws.md/correlated-failure/index.md)
- **Race conditions, concurrency** → [Law 3: Emergence](..../core-principles/laws.md/emergent-chaos/index.md)
- **Consensus, coordination** → [Law 4: Trade-offs](..../core-principles/laws.md/multidimensional-optimization/index.md) and [Law 5: Knowledge](..../core-principles/laws.md/distributed-knowledge/index.md)
- **Monitoring, observability** → [Law 5: Epistemology](..../core-principles/laws.md/distributed-knowledge/index.md)
- **UX, operations, tooling** → [Law 6: Human-API](..../core-principles/laws.md/cognitive-load/index.md)
- **Cost, resources, scaling** → [Law 7: Economics](..../core-principles/laws.md/economic-reality/index.md)

## Archived Content

The original 8-law content is preserved in the archive for reference:
- [Archive: Old 8-Law Structure](..../core-principles/laws.md/archive-old-8-law-structure/index.md)
