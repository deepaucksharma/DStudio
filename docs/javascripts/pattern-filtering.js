...
const patterns = [
    ...
    { name: "Timeout Advanced", category: "resilience", tier: "silver", status: "stable", description: "Advanced timeout strategies", url: "/DStudio/pattern-library/resilience/timeout-advanced/", tags: ["timeout", "performance", "advanced"] },
    { name: "Fault Tolerance", category: "resilience", tier: "silver", status: "stable", description: "Design systems to handle component failures", url: "/DStudio/patterns/fault-tolerance/", tags: ["reliability", "redundancy"] },
    { name: "Multi-Region", category: "resilience", tier: "gold", status: "recommended", description: "Deploy across multiple geographic regions", url: "/DStudio/patterns/multi-region/", tags: ["geo", "availability", "disaster-recovery"] },
    
    // Data Management Patterns
    { name: "CQRS", category: "distributed-data", tier: "gold", status: "recommended", description: "Separate read and write models for scalability", url: "/DStudio/pattern-library/data-management/cqrs/", tags: ["scalability", "performance", "separation"] },
    { name: "Event Sourcing", category: "distributed-data", tier: "gold", status: "recommended", description: "Store state changes as immutable events", url: "/DStudio/pattern-library/data-management/event-sourcing/", tags: ["audit", "replay", "events"] },
    { name: "Saga", category: "distributed-data", tier: "gold", status: "recommended", description: "Manage distributed transactions across services", url: "/DStudio/pattern-library/data-management/saga/", tags: ["transactions", "consistency", "coordination"] },
    { name: "Change Data Capture", category: "distributed-data", tier: "gold", status: "recommended", description: "Track and capture database changes", url: "/DStudio/pattern-library/data-management/cdc/", tags: ["streaming", "replication", "events"] },
    { name: "Outbox Pattern", category: "distributed-data", tier: "gold", status: "recommended", description: "Reliable event publishing with transactions", url: "/DStudio/pattern-library/data-management/outbox/", tags: ["reliability", "events", "transactions"] },
    { name: "Consistent Hashing", category: "distributed-data", tier: "gold", status: "recommended", description: "Distribute data across nodes efficiently", url: "/DStudio/pattern-library/data-management/consistent-hashing/", tags: ["partitioning", "scalability", "distribution"] },
    { name: "Eventual Consistency", category: "distributed-data", tier: "silver", status: "stable", description: "Allow temporary inconsistencies for availability", url: "/DStudio/pattern-library/data-management/eventual-consistency/", tags: ["consistency", "cap", "availability"] },
    { name: "Materialized View", category: "distributed-data", tier: "silver", status: "stable", description: "Pre-computed query results for performance", url: "/DStudio/pattern-library/data-management/materialized-view/", tags: ["performance", "denormalization", "caching"] },
    { name: "Write-Ahead Log", category: "distributed-data", tier: "gold", status: "recommended", description: "Ensure durability with sequential writes", url: "/DStudio/pattern-library/data-management/write-ahead-log/", tags: ["durability", "recovery", "transactions"] },
    ...
    { name: "Sidecar", category: "architectural", tier: "gold", status: "recommended", description: "Deploy functionality alongside application", url: "/DStudio/pattern-library/architecture/sidecar/", tags: ["deployment", "separation", "proxy"] },
    { name: "Ambassador", category: "architectural", tier: "silver", status: "stable", description: "Proxy for external services", url: "/DStudio/pattern-library/architecture/ambassador/", tags: ["proxy", "external", "abstraction"] },
    { name: "Strangler Fig", category: "architectural", tier: "gold", status: "recommended", description: "Gradually replace legacy systems", url: "/DStudio/pattern-library/architecture/strangler-fig/", tags: ["migration", "legacy", "incremental"] },
    { name: "Backends for Frontends", category: "architectural", tier: "silver", status: "stable", description: "Separate backends for different frontends", url: "/DStudio/pattern-library/architecture/backends-for-frontends/", tags: ["api", "frontend", "optimization"] },
    { name: "Anti-Corruption Layer", category: "architectural", tier: "silver", status: "stable", description: "Isolate legacy systems from new code", url: "/DStudio/pattern-library/architecture/anti-corruption-layer/", tags: ["legacy", "isolation", "translation"] },
    { name: "Cell-Based Architecture", category: "architectural", tier: "gold", status: "recommended", description: "Isolated deployment units for resilience", url: "/DStudio/pattern-library/architecture/cell-based/", tags: ["isolation", "resilience", "blast-radius"] },
    { name: "Choreography", category: "architectural", tier: "silver", status: "stable", description: "Decentralized workflow coordination", url: "/DStudio/pattern-library/architecture/choreography/", tags: ["workflow", "decentralized", "events"] },
    { name: "Event-Driven Architecture", category: "architectural", tier: "gold", status: "recommended", description: "System driven by event production and consumption", url: "/DStudio/pattern-library/architecture/event-driven/", tags: ["events", "async", "decoupling"] },
    { name: "Serverless/FaaS", category: "architectural", tier: "silver", status: "stable", description: "Function-as-a-Service architecture", url: "/DStudio/pattern-library/architecture/serverless-faas/", tags: ["serverless", "functions", "auto-scaling"] },
    { name: "Shared Nothing", category: "architectural", tier: "gold", status: "recommended", description: "No shared state between nodes", url: "/DStudio/pattern-library/architecture/shared-nothing/", tags: ["isolation", "scalability", "stateless"] },
    ...
    { name: "Geohashing", category: "specialized", tier: "silver", status: "stable", description: "Encode geographic coordinates efficiently", url: "/DStudio/patterns/geohashing/", tags: ["geo", "spatial", "indexing"] },
    { name: "ID Generation at Scale", category: "specialized", tier: "gold", status: "recommended", description: "Generate unique IDs in distributed systems", url: "/DStudio/patterns/id-generation-scale/", tags: ["uuid", "snowflake", "uniqueness"] },
    { name: "URL Normalization", category: "specialized", tier: "silver", status: "stable", description: "Standardize URLs for consistency", url: "/DStudio/patterns/url-normalization/", tags: ["web", "standardization", "crawling"] },
    { name: "Deduplication", category: "specialized", tier: "silver", status: "stable", description: "Remove duplicate data efficiently", url: "/DStudio/patterns/deduplication/", tags: ["storage", "efficiency", "cleanup"] },
    { name: "Analytics at Scale", category: "specialized", tier: "gold", status: "recommended", description: "Process large-scale analytics workloads", url: "/DStudio/patterns/analytics-scale/", tags: ["big-data", "analytics", "processing"] },
    { name: "Event Streaming", category: "specialized", tier: "silver", status: "stable", description: "Process continuous streams of events", url: "/DStudio/patterns/event-streaming/", tags: ["streaming", "real-time", "events"] },
    { name: "Request Routing", category: "specialized", tier: "silver", status: "stable", description: "Direct requests to appropriate handlers", url: "/DStudio/patterns/request-routing/", tags: ["routing", "dispatch", "handling"] },
    { name: "Valet Key", category: "specialized", tier: "silver", status: "stable", description: "Provide temporary direct access to resources", url: "/DStudio/patterns/valet-key/", tags: ["security", "access", "temporary"] },
    { name: "Queues and Streaming", category: "specialized", tier: "silver", status: "stable", description: "Comparison of queuing vs streaming patterns", url: "/DStudio/patterns/queues-streaming/", tags: ["messaging", "comparison", "architecture"] },
    { name: "Tunable Consistency", category: "specialized", tier: "silver", status: "stable", description: "Adjust consistency levels dynamically", url: "/DStudio/patterns/tunable-consistency/", tags: ["consistency", "flexibility", "trade-offs"] },
    { name: "Time Series IDs", category: "specialized", tier: "silver", status: "stable", description: "Generate IDs for time-series data", url: "/DStudio/patterns/time-series-ids/", tags: ["time-series", "ids", "ordering"] },
    { name: "Tile Caching", category: "specialized", tier: "silver", status: "stable", description: "Cache map tiles for performance", url: "/DStudio/patterns/tile-caching/", tags: ["maps", "caching", "geo"] },
    { name: "Spatial Indexing", category: "specialized", tier: "silver", status: "stable", description: "Index spatial data for efficient queries", url: "/DStudio/patterns/spatial-indexing/", tags: ["spatial", "indexing", "geo"] },
    { name: "CAP Theorem", category: "specialized", tier: "bronze", status: "legacy", description: "Consistency, Availability, Partition tolerance trade-offs", url: "/DStudio/patterns/cap-theorem/", tags: ["theory", "trade-offs", "distributed"] },
    ...
    { name: "Data Mesh", category: "specialized", tier: "silver", status: "stable", description: "Decentralized data architecture", url: "/DStudio/patterns/data-mesh/", tags: ["architecture", "decentralization", "ownership"] },
    ...
    { name: "Adaptive Scheduling", category: "specialized", tier: "silver", status: "stable", description: "Dynamically adjust task scheduling", url: "/DStudio/patterns/adaptive-scheduling/", tags: ["scheduling", "optimization", "dynamic"] },
    { name: "Blue-Green Deployment", category: "specialized", tier: "silver", status: "stable", description: "Zero-downtime deployment strategy", url: "/DStudio/patterns/blue-green-deployment/", tags: ["deployment", "zero-downtime", "rollback"] },
    ...
    { name: "Fault Tolerance", category: "specialized", tier: "silver", status: "stable", description: "Design systems to handle component failures", url: "/DStudio/patterns/fault-tolerance/", tags: ["reliability", "redundancy"] },
    ...
    { name: "Idempotent Receiver", category: "specialized", tier: "gold", status: "recommended", description: "Handle duplicate messages safely", url: "/DStudio/patterns/idempotent-receiver/", tags: ["reliability", "deduplication"] },
    ...
    { name: "Multi-Region", category: "specialized", tier: "gold", status: "recommended", description: "Deploy across multiple geographic regions", url: "/DStudio/patterns/multi-region/", tags: ["geo", "availability", "disaster-recovery"] },
    { name: "Observability", category: "specialized", tier: "gold", status: "recommended", description: "Comprehensive system monitoring and tracing", url: "/DStudio/patterns/observability/", tags: ["monitoring", "tracing", "metrics"] },
    ...
    { name: "Single Socket Channel", category: "specialized", tier: "silver", status: "stable", description: "Single connection for multiple streams", url: "/DStudio/patterns/single-socket-channel/", tags: ["networking", "multiplexing", "efficiency"] },
    { name: "Singleton Database", category: "specialized", tier: "bronze", status: "legacy", description: "Single database for all services", url: "/DStudio/patterns/singleton-database/", tags: ["anti-pattern", "bottleneck"] },
    ...
    { name: "Stored Procedures", category: "specialized", tier: "bronze", status: "legacy", description: "Business logic in database", url: "/DStudio/patterns/stored-procedures/", tags: ["database", "logic", "coupling"] },
    { name: "Thick Client", category: "specialized", tier: "bronze", status: "legacy", description: "Heavy client-side processing", url: "/DStudio/patterns/thick-client/", tags: ["client", "processing", "desktop"] }
];
