...
| Criteria | Exceptional (68-75) | Proficient (53-67) | Developing (38-52) | Inadequate (0-37) |
|----------|---------------------|-------------------|-------------------|-------------------|
| **Axiom Application** (25 pts) | • All 8 axioms explicitly addressed<br>• Deep understanding shown<br>• Creative applications<br>• Clear connections | • Most axioms addressed<br>• Good understanding<br>• Standard applications<br>• Some connections | • Some axioms addressed<br>• Basic understanding<br>• Simple applications<br>• Few connections | • Few axioms addressed<br>• Poor understanding<br>• Minimal application<br>• No connections |
