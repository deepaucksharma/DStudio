...
<div class="pattern-header">
  ...
  <div class="pattern-summary">Guarantee durability by writing intended changes to a sequential log before modifying the actual data, enabling crash recovery and transaction support.</div>
</div>
