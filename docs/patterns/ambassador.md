...
<!-- Navigation -->
[Home](../introduction/index.md) → [Part III: Patterns](index.md) → **Ambassador Pattern**
...
**Previous**: [← Backends for Frontends](backends-for-frontends.md) | **Next**: [Anti-Corruption Layer →](anti-corruption-layer.md)