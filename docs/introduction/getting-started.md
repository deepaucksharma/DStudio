...
|------|-------|----------------|-------------|
| **1-2** | Core Laws | • Read [Law 1: Failure](/part1-axioms/law1-failure/)<br/>• Study Laws 2-4<br/>• Work examples | Understanding checklist |
| **3-4** | First Patterns | • [Circuit Breaker](/patterns/circuit-breaker)<br/>• [Retry Logic](/patterns/retry-backoff)<br/>• [Load Balancing](/patterns/load-balancing) | Implement 1 pattern |
| **5-6** | Quantitative Tools | • [Little's Law](/quantitative/littles-law)<br/>• [Availability Math](/quantitative/availability-math)<br/>• Use calculators | Capacity plan |
| **7-8** | Real Systems | • Study [case studies](/case-studies/)<br/>• [Synthesis exercises](/part1-axioms/synthesis) | Final project |
...
1. **[Correlated Failure](/part1-axioms/law1-failure/)** - Failures cascade and correlate
2. **[Asynchronous Reality](/part1-axioms/law2-asynchrony/)** - No shared time, only happens-before
3. **[Emergent Chaos](/part1-axioms/law3-emergence/)** - Complexity breeds unpredictability
4. **[Multidimensional Optimization](/part1-axioms/law4-tradeoffs/)** - Every choice has ripple effects
5. **[Distributed Knowledge](/part1-axioms/law5-epistemology/)** - Truth is local and uncertain
6. **[Cognitive Load](/part1-axioms/law6-human-api/)** - Human understanding has limits
7. **[Economic Reality](/part1-axioms/law7-economics/)** - Resources shape all decisions
...
#### For Quick Reference
1. [Pattern selector tool](/patterns/pattern-selector)
2. [Cheat sheets](/reference/cheat-sheets)
3. [Recipe cards](/reference/recipe-cards)
...
3. **Start with Law 1**: [Begin with failure](/part1-axioms/law1-failure/)
...
!!! success "You're Ready!"
    ...
    **Your journey starts here. Let's begin! →** [Law 1: Correlated Failure](/part1-axioms/law1-failure/)
